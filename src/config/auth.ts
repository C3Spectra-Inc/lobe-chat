...
declare global {
  ...
  namespace NodeJS {
    interface ProcessEnv {
      ...
      NEXT_AUTH_COOKIE_SAMESITE_NONE?: string;
...
export const getAuthConfig = () => {
  ...
  return createEnv({
    ...
    server: {
      ...
      NEXT_AUTH_COOKIE_SAMESITE_NONE: z.boolean().optional(),
    ...
    runtimeEnv: {
      ...
      NEXT_AUTH_COOKIE_SAMESITE_NONE: process.env.NEXT_AUTH_COOKIE_SAMESITE_NONE === '1',
